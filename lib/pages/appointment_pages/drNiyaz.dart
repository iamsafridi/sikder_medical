...
class DrNiyaz extends StatefulWidget {
  const DrNiyaz({super.key});

  @override
  State<DrNiyaz> createState() => _DrNiyazState();
}

class _DrNiyazState extends State<DrNiyaz> {
  _DrNiyazState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'DR. NIAZUR RAHMAN');

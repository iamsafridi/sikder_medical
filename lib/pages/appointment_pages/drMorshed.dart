...
class DrMorshed extends StatefulWidget {
  const DrMorshed({super.key});

  @override
  State<DrMorshed> createState() => _DrMorshedState();
}

class _DrMorshedState extends State<DrMorshed> {
  _DrMorshedState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'DR. TAREQ MORSHED');

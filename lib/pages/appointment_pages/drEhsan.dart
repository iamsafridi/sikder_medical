...
class DrEhsan extends StatefulWidget {
  const DrEhsan({super.key});

  @override
  State<DrEhsan> createState() => _DrEhsanState();
}

class _DrEhsanState extends State<DrEhsan> {
  _DrEhsanState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'PROFESSOR. DR. EHSAN MAHMOOD');

...
class DrNazir extends StatefulWidget {
  const DrNazir({super.key});

  @override
  State<DrNazir> createState() => _DrNazirState();
}

class _DrNazirState extends State<DrNazir> {
  _DrNazirState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'Dr. GMM Nagir Hossain');

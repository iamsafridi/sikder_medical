...
class DrKisor extends StatefulWidget {
  const DrKisor({super.key});

  @override
  State<DrKisor> createState() => _DrKisorState();
}

class _DrKisorState extends State<DrKisor> {
  _DrKisorState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'LT. COL. DR. KISHORE KUMAR DAS');

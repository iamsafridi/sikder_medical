...
class DrBari extends StatefulWidget {
  const DrBari({super.key});

  @override
  State<DrBari> createState() => _DrBariState();
}

class _DrBariState extends State<DrBari> {
  _DrBariState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'PROFESSOR DR. RAHMATUL BARI');

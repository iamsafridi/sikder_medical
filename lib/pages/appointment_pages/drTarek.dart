...
class DrTarek extends StatefulWidget {
  const DrTarek({super.key});

  @override
  State<DrTarek> createState() => _DrTarekState();
}

class _DrTarekState extends State<DrTarek> {
  _DrTarekState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'DR. MD. ZANZIBUL TAREQ');

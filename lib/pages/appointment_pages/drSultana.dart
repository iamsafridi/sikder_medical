...
class DrSultana extends StatefulWidget {
  const DrSultana({super.key});

  @override
  State<DrSultana> createState() => _DrSultanaState();
}

class _DrSultanaState extends State<DrSultana> {
  _DrSultanaState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'DR. SHARMIN SULTANA');

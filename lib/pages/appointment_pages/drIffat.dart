...
class DrIffat extends StatefulWidget {
  const DrIffat({super.key});

  @override
  State<DrIffat> createState() => _DrIffatState();
}

class _DrIffatState extends State<DrIffat> {
  _DrIffatState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'DR. IFFAT RAHMAN');

...
class DrMasud extends StatefulWidget {
  const DrMasud({super.key});

  @override
  State<DrMasud> createState() => _DrMasudState();
}

class _DrMasudState extends State<DrMasud> {
  _DrMasudState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'DR. MD. MAHMUDUR-UR-RAHMAN(MASUD)');

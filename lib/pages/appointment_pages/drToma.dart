...
class DrToma extends StatefulWidget {
  const DrToma({super.key});

  @override
  State<DrToma> createState() => _DrTomaState();
}

class _DrTomaState extends State<DrToma> {
  _DrTomaState() {
  ...
  TextEditingController _drname =
      TextEditingController(text: 'DR. TANIMA TAMA');
